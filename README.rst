...
The version of the program described here, 0.9.0a7, is alpha quality software,
...
Please note Debian Jessie is too old to run version 0.9.0a7.
...
``python3 install.py rapid-photo-downloader-0.9.0a7.tar.gz``
