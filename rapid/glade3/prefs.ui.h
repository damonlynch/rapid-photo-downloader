...
char *s = N_("If you disable automatic detection, choose the exact backup location.");
char *s = N_("If you disable automatic detection, choose the exact location of the images and videos.");
char *s = N_("If you enable automatic detection of Portable Storage Devices, the entire device will be scanned for images. On large devices, this could take some time.");
char *s = N_("Job Codes");
char *s = N_("Location:");
char *s = N_("Miscillaneous");
char *s = N_("Overwrite");
