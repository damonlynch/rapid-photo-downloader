...
class Application(QtSingleApplication):
    ...
    def __init__(self, programId: str, *argv) -> None:
        ...
        self._raw_accent_colour: tuple = self._accentColor.getRgbF()[:3]
    ...
    def setStartupPalette(self):
        ...
        self._raw_color_scheme = self._callDBus(iface=iface, key="color-scheme")
        self._raw_accent_colour = self._callDBus(iface=iface, key="accent-color")
